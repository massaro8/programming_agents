...
- `src/agentready/templates/python/template/src/{{ package_name }}/application/__init__.py.jinja`
- `src/agentready/templates/python/template/src/{{ package_name }}/application/service.py.jinja`
